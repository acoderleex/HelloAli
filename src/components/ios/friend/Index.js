...
import AppInfoView from './../details/Index';
...
const FriendView = React.createClass({
  ...
  handleItemClick(item) {
    this.navigatorPush('app', item.title, AppInfoView, {backButtonText: '支付宝'});
  },

  handleLifeCircleClick() {
      this.navigatorPush('app', '更多尼玛', AppInfoView, {backButtonText: 'nis宝'});
  },
